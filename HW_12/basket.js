...
const basketCounterEl = document.querySelector(".basketIconWrap span");
 ...
 */
document.querySelector(".basketIconWrap").addEventListener("click", () => {
    ...
    <div class="basketRow" data-id="${product.id}">
      ...
      <div>
        <span class="productTotalRow">
          ${(product.price * product.count).toFixed(2)} рублей
        </span>
      </div>
